...
Token permutation uses raw torch_npu kernels. FP32/BF16 router probabilities keep
...
def ensure_chunk_sort_kernels_registered():
    ...
    from transformer_engine.pytorch.permutation import (
        moe_chunk_sort_forward, moe_chunk_sort_backward,
    )
    moe_chunk_sort_forward.register_kernel("npu", _tefl_chunk_sort_fwd)
    moe_chunk_sort_backward.register_kernel("npu", _tefl_chunk_sort_bwd)
    _CHUNK_SORT_KERNELS_REGISTERED = True
